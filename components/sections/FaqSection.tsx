...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Covenant Charge works with churches, synagogues, mosques, schools, and any mission-driven organization regardless of denomination or tradition. The program is designed to serve the common good, not any particular faith community.",
  },
  {
